...
class AllowListTests(TestCase):
    ...
    def test_allowed_user_can_view_details_and_follow(self):
        ...
        self.client.post(
            reverse('portfolios:portfolio-follow-toggle', args=[self.portfolio.url_tag])
        )
        self.assertTrue(
...
class ExplorePageTests(TestCase):
    ...
    def test_explore_uses_snapshot_without_fetching_quotes(self):
        ...
        Portfolio.objects.create(
            user=user3,
            name='Gamma Stack',
            substack_url='https://gamma.substack.com',
            holdings={'AAPL': 5},
        )
...
class FollowPortfolioTests(TestCase):
    ...
    def test_follow_requires_login(self):
        url = reverse('portfolios:portfolio-follow-toggle', args=[self.portfolio.url_tag])
    ...
    def test_follower_notified_on_trade(self, mock_send, mock_quote):
        ...
        self.client.login(username='viewer', password='pass')
        follow_url = reverse('portfolios:portfolio-follow-toggle', args=[self.portfolio.url_tag])
