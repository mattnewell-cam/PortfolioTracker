...
urlpatterns = [
    ...
    path("public/<slug:url_tag>/", views.PublicPortfolioDetailView.as_view(), name="portfolio-public-detail"),
    ...
    path("follow/<slug:url_tag>/", views.toggle_follow, name="portfolio-follow-toggle"),
