...
urlpatterns = [
    ...
    path("public/<slug:tag>/", views.PublicPortfolioDetailView.as_view(), name="portfolio-public-detail"),
    ...
    path("follow/<slug:tag>/", views.toggle_follow, name="portfolio-follow-toggle"),
